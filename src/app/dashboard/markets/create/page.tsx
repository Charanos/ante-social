...
import {
    ...
    Users, Activity, Brain, ShieldAlert, Trophy, Calendar, DollarSign, Clock, LoaderPinwheel
} from "lucide-react"
        ...
        return (
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="text-center space-y-4 max-w-sm">
                    ...
                    <p className="text-gray-500">Only platform administrators can create new markets. Redirecting...</p>
                </div>
            </div>
        )
    }
