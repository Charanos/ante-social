...
import { Users, Clock, TrendingUp, CheckCircle2, Shield, ArrowRight, ScanEye } from "lucide-react"
...
const getMockPollMarket = (id: string) => {
    const markets: Record<string, any> = {
        "poll-001": {
            ...
            description: "Vote for the most reliable, comfortable, and safest matatu route in Nairobi. Consider factors like speed, music, conductor vibes, and overall passenger experience.",
            ...
            options: [
                { id: "opt1", option_text: "Route 111 (Ngong Road)", votes: 15, percentage: 32, image: "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=800&auto=format&fit=crop" },
                { id: "opt2", option_text: "Route 125/126 (Rongai)", votes: 18, percentage: 38, image: "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=800&auto=format&fit=crop" },
                { id: "opt3", option_text: "Route 23 (Westlands)", votes: 8, percentage: 17, image: "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=800&auto=format&fit=crop" },
                { id: "opt4", option_text: "Route 58 (Buruburu)", votes: 6, percentage: 13, image: "https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=800&auto=format&fit=crop" }
            ],
            participants: [
        ...
        "poll-002": {
            ...
            description: "AFC Leopards vs Gor Mahia - predict the winner of Kenya's biggest football rivalry",
            ...
            options: [
                { id: "opt1", option_text: "AFC Leopards Win", votes: 35, percentage: 38, image: "https://images.unsplash.com/photo-1606925797300-0b35e9d1794e?w=800&auto=format&fit=crop" },
                { id: "opt2", option_text: "Gor Mahia Win", votes: 48, percentage: 52, image: "https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&auto=format&fit=crop" },
                { id: "opt3", option_text: "Draw", votes: 10, percentage: 10, image: "https://images.unsplash.com/photo-1529993654-293d0c6e4b84?w=800&auto=format&fit=crop" }
            ],
            participants: [
                { username: "@leopards_fan", total_stake: 3000, timestamp: new Date(Date.now() - 10800000) },
                { username: "@kogalo", total_stake: 5000, timestamp: new Date(Date.now() - 5400000) },
                { username: "@neutral_better", total_stake: 1000, timestamp: new Date(Date.now() - 2700000) }
            ]
        },
        "poll-003": {
            id: "poll-003",
            ...
            image: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=1200&auto=format&fit=crop",
            category: "Poll",
            market_type: "poll",
            buy_in_amount: 300,
            total_pool: 67800,
            ...
            options: [
                { id: "opt1", option_text: "7-9 AM (Morning Rush)", votes: 12, percentage: 35, image: "https://images.unsplash.com/photo-1508146544796-045a7653611a?w=800&auto=format&fit=crop" },
                { id: "opt2", option_text: "5-7 PM (Evening Rush)", votes: 18, percentage: 53, image: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&auto=format&fit=crop" },
                { id: "opt3", option_text: "12-2 PM (Lunch Hour)", votes: 4, percentage: 12, image: "https://images.unsplash.com/photo-1502905172761-5b55a56d33f2?w=800&auto=format&fit=crop" }
            ],
            participants: [
                { username: "@commuter_daily", total_stake: 500, timestamp: new Date(Date.now() - 14400000) },
                { username: "@traffic_master", total_stake: 1200, timestamp: new Date(Date.now() - 7200000) }
            ]
        }
    };
...
export default function PollMarketPage() {
    ...
    const handlePlaceBet = () => {
        ...
        setTimeout(() => {
            ...
            toast.success("Vote Placed!", `You voted ${stakeAmount} KSH on "${selectedOptionText}"`)
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-black/50 font-medium">Placed vote</p>
                                            </div>
                                        </div>
                        ...
                        <div className="sticky top-6 space-y-6">
                            ...
                            >
                                ...
                                <div className="p-6 bg-black">
                                    <h3 className="text-xl font-semibold text-white mb-1">Place Your Vote</h3>
                                    <p className="text-sm text-white/60 font-medium">Join the poll and win</p>
                                </div>
