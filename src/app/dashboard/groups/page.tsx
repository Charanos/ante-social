          ...
          <CardContent className="p-6 relative z-10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-3xl font-medium font-mono text-blue-900">{groups.length}</p>
              </div>
                ...
                <CardHeader className="border-b border-gray-50 pb-4">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 text-xl font-medium text-white shadow-md group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-300">
                        {group.name.charAt(0)}
                      </div>
                      <div>
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="font-medium text-gray-700 ml-1">{group.member_count}</span>
                      <span className="text-gray-400 text-xs">members</span>
                    </div>
                    <div className="rounded-full bg-green-50 px-3 py-1 text-[10px] font-medium uppercase tracking-wide text-green-700">
