...
export default function PrivateMarketDetailsPage() {
  ...
  const [market, setMarket] = useState({
    ...
    creator: "AdminUser",
    participants: [
      { id: "u1", name: "Alpha", selected: "Option A", joined: "2h ago", avatar: "A" },
      { id: "u2", name: "Bravo", selected: "Option B", joined: "1h ago", avatar: "B" },
      { id: "u3", name: "Charlie", selected: "Option A", joined: "30m ago", avatar: "C" },
    ]
  })
        ...
        <div className="glass-panel p-8 rounded-3xl border-white/50 bg-white/40 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className={cn(
                "px-3 py-1 rounded-full text-[10px] font-semibold uppercase tracking-wider border backdrop-blur-md",
                market.status === 'active' ? 'bg-green-500/10 text-green-700 border-green-200' :
                  market.status === 'settled' ? 'bg-gray-500/10 text-gray-700 border-gray-200' :
                    ...
                    {market.type === "winner_takes_all" ? (
                      ...
                      <>
                        <div className="flex items-center gap-3 mb-6">
                          ...
                          <div>
                            <h2 className="text-xl font-semibold text-gray-900">Make Your Choice</h2>
                            <p className="text-xs text-gray-500">Outcome Strategy: Odd One Out</p>
                          </div>
                        </div>

                        <p className="text-sm text-gray-600 mb-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
                          <strong>How to win:</strong> Pick the option that is the <strong>least popular</strong>.
                        </p>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-3xl border-white/50 bg-white/60">
              ...
              <div className="space-y-3">
                {market.participants.map((player) => (
                  <div key={player.id} className="flex items-center justify-between p-3 rounded-2xl bg-white/50 hover:bg-white transition-colors border border-transparent hover:border-gray-100 group">
