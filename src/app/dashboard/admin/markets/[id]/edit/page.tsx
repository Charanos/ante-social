...
export default function EditMarketPage() {
  ...
  const handleAddOutcome = () => {
    setOutcomes([
      ...outcomes,
      { id: outcomes.length + 1, name: "", image: "" },
    ]);
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-600 mt-0.5">
                Update market details and outcomes
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 mt-1.5">
                Affects early bettor bonus calculations
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              />
              <p className="text-xs text-neutral-600 mt-1.5">
                If set, market will automatically publish at this time
              </p>
            </div>
          </div>
        </motion.div>
                ...
                <div>
                  ...
                  {outcome.image ? (
                    ...
                    <button className="w-full px-3.5 py-2.5 rounded-lg border border-neutral-200 bg-white hover:bg-neutral-50 transition-all flex items-center justify-center gap-2 group cursor-pointer">
                      <IconUpload className="w-4 h-4 text-neutral-600 group-hover:text-neutral-700 transition-colors" />
