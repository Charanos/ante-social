...
import { IconAward, IconRefresh, IconSearch, IconTrendingUp, IconUser, IconUsers } from '@tabler/icons-react';
...
export default function LeaderboardPage() {
  ...
  const getRankIcon = (rank: number) => {
    switch (rank) {
      ...
      default:
        return (
          <span className="text-sm font-medium text-neutral-600">#{rank}</span>
        );
    }
  };
  ...
  return (
    <div className="min-h-screen pb-12">
      <div className="max-w-full mx-auto px-6 pb-8">
        {/* Header */}
        <DashboardHeader subtitle="View all users ranked by MP balance" />
        ...
        >
          <DashboardCard className="p-5 mb-10">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="IconSearch by username, name, email, or user ID..."
                value={searchQuery}
        ...
        <div className="flex items-center gap-4 mb-10">
          <div className="h-px flex-1 bg-linear-to-r from-transparent via-neutral-200 to-transparent"></div>
          <h2 className="text-xs font-medium text-neutral-500 uppercase tracking-wider">
            Rankings ({mockLeaderboard.length})
          </h2>
          <div className="h-px flex-1 bg-linear-to-r from-transparent via-neutral-200 to-transparent"></div>
        </div>
