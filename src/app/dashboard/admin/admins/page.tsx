                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="text-sm font-medium text-neutral-900">{admin.name}</h3>
                        <span className={`px-2 py-0.5 text-[10px] font-medium rounded-full border ${getRoleBadgeStyles(admin.role)} uppercase tracking-wide`}>
                          {admin.role}
                        </span>
                      </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-sm font-medium ${admin.status === "Active" ? "text-green-700" : "text-neutral-600"}`}>
                        {admin.status}
                      </span>
                    </div>
