...
import { IconArrowRight, IconCircleCheckFilled, IconGlobe, IconLock, IconShield, IconTrendingUp } from '@tabler/icons-react';;
              ...
              <div className="flex-1">
                <div className="flex flex-col gap-2 mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {!group.isPublic && !showVisibilityBadge && (
                      <IconShield className="w-3.5 h-3.5 text-black/30" />
                    )}
                  </div>
                </div>
                {!group.image && (
            ...
            <div className="flex items-center justify-between pt-4 border-t border-black/5 mt-auto">
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-2 flex items-baseline">
                    <span className="text-xs font-semibold text-black/80 font-mono">
              ...
              {featured && group.growth ? (
                <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-orange-500/10 border border-orange-500/20">
                  <IconTrendingUp className="w-3 h-3 text-orange-600" />
