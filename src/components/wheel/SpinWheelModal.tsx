        ...
        >
          ...
          <div className="relative mb-6">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1.5 z-20">
              <div className="w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-t-[18px] border-t-amber-500 drop-shadow-lg" />
            </div>
          ...
          <AnimatePresence>
            {wonAmount !== null && (
              ...
              >
                ...
                <p className="text-2xl font-medium font-mono text-green-800">{wonAmount} MP</p>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <button
            ...
            `}
          >
            {hasSpunToday ? '✓ Spun Today - Come Back Tomorrow' : isSpinning ? 'Spinning...' : 'Spin the Wheel'}
          </button>
