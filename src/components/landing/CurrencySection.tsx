            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <div className="flex items-center gap-4 p-4 rounded-xl bg-green-50 border border-green-100">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-green-900 numeric">
                    Up to $500/day
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 rounded-xl bg-blue-50 border border-blue-100">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium text-blue-900 numeric">
                    Up to $5,000/day
                  </p>
                </div>
              </div>
            ...
            <div className="relative z-10 p-8 rounded-3xl bg-white border border-neutral-100 shadow-2xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <div className="p-6 rounded-2xl bg-neutral-50 border border-neutral-100">
                  ...
                  <p className="text-3xl font-medium text-black tracking-tight numeric">
                    $1,250.50
                  </p>
                </div>
                <div className="p-6 rounded-2xl bg-green-50/50 border border-green-100/50">
                  ...
                  <p className="text-3xl font-medium text-green-700 tracking-tight numeric">
                    +$980.50
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-8">
                ...
                {[1, 2, 3].map((_, i) => (
                  <div
                    key={i}
                    className="flex items-center justify-between p-4 rounded-xl hover:bg-neutral-50 transition-colors cursor-default"
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${i === 2 ? "bg-red-50 text-red-500" : "bg-green-50 text-green-500"}`}
                      >
                        {i === 2 ? (
                    ...
                    <span
                      className={`text-sm font-medium numeric ${i === 2 ? "text- red-500" : "text-green-600"}`}
                    >
                      {i === 2 ? "-$50" : "+$150"}
                    </span>
                  </div>
