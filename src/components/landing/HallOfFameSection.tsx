      ...
      <div className="flex justify-center mb-24">
        <div className="bg-neutral-100 p-1 rounded-full flex items-center">
          <button
            ...
            className={cn(
              "px-6 py-2 rounded-full text-sm hover:cursor-pointer font-medium transition-all",
              timeframe === "weekly"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 items-end">
        ...
        >
          ...
          <div className="text-sm font-medium text-neutral-500 mb-3">
            {leaders[1].winRate} Win Rate
          </div>
          <div className="text-2xl font-mono font-medium text-green-600">
            {leaders[1].profit}
          </div>
        </motion.div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-neutral-100 shadow-sm overflow-hidden">
        <div className="p-8">
          ...
          <div className="mt-8 text-center p-6 bg-neutral-50 rounded-2xl border border-neutral-100">
            ...
            <Link
              href="/register"
              className="inline-block px-6 py-2 bg-black text-white rounded-full font-medium hover:bg-neutral-800 transition-colors shadow-lg hover:shadow-xl hover:-translate-y-1"
            >
