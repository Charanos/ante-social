  ...
  return (
    <>
      ...
      >
        ...
        {/* Featured badge */}
        {market.isFeatured && (
          <div className="absolute top-3 left-4 z-20 flex items-center gap-1 px-2 py-1 bg-amber-400/90 backdrop-blur-sm rounded-full">
        ...
        <Link href={linkHref} className="block h-full">
          <div className="flex flex-col justify-between h-full max-h-[420px]">
            ...
            <div className="relative p-6 h-full min-h-[250px] flex flex-col justify-between">
              ...
              {/* Recurring badge */}
              {market.isRecurring && (
                <div className="flex items-center gap-1.5 px-2 py-1 w-fit rounded-full bg-green-100/80 border border-green-200/50">
                  <svg className="w-3 h-3 text-green-600 animate-spin" style={{ animationDuration: '3s' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                    <path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" /><path d="M21 3v5h-5" /><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" /><path d="M8 16H3v5" />
                  </svg>
                  <span className="text-[10px] font-semibold text-green-700">Recurring</span>
                </div>
              )}
