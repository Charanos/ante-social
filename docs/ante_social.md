...
- High Roller badge message: _"An Ante Social honor, reserved for those who made fortune bend first."_
...
**Example Scenario:**
_"When suddenly added to a new group chat, the majority would…"_
...
### 5. Consensus Divergence (Odd One Out)

**Premise:**
The option with the **fewest votes** wins. A test of your ability to identify the non-consensus view and predict where the crowd _won't_ go.

**Mechanics:**

- Minority wins (the "Odd One Out")
- Rewards contrarian thinking and social divergence
- High multipliers for extreme minority outcomes
- Supports 3+ options to reduce tie probability
...
1. **Admin Declaration:**
   ...
   - Group notification sent: _"@alex declared @jamie as winner."_
...
3. **Disagree Action:**
   - Modal displayed: _"Are you sure? This will pause payout for everyone until the admin reviews."_
...
- If everyone picks the same option:
  ...
  - UI message: _"Everyone chose the same. House keeps the fee; try again, fools."_

**Activity Feed:**

- Shows only: _"placed $X"_
